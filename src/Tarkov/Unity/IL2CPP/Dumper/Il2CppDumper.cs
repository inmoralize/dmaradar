...
namespace eft_dma_radar.Tarkov.Unity.IL2CPP
{
    public static partial class Il2CppDumper
    {
        ...
        /// <summary>
        /// Summary of the last IL2CPP dump/cache operation.
        /// </summary>
        public static string HealthSummary { get; private set; } = "Not initialized";
        ...
        public static void Dump()
        {
            ...
            {
                _dumped = true;
                HealthSummary = $"Restored from cache (RVA: 0x{Offsets.Special.TypeInfoTableRva:X})";
                Log.WriteLine($"[Il2CppDumper] {HealthSummary} — live dump skipped.");
                return;
            }
            ...
            HealthSummary = $"Live dump complete. {classes.Count} classes, {updated} updated, {fallback} fallback, {classesSkipped} skipped. RVA: 0x{Offsets.Special.TypeInfoTableRva:X}";
            Log.WriteLine($"[Il2CppDumper] {HealthSummary}");
